...
def get_today_theme_and_query():
    ...
    themes = {
        ...
        5: {"name": "문화와 역사 (전통/문화유산)", "query": "문화재 OR 역사 OR 전통문화 OR 유산 OR 박물관"},
        6: {"name": "인물과 도전 (위인/성장)", "query": "위인 OR 도전 OR 성장 OR 봉사활동 OR 스포츠정신"}
    }
...
BLACKLIST_KEYWORDS = [
    ...
    "뉴스 모음", "주요 뉴스", "종합뉴스", "와이드", "이슈 정리",
    "한주 정리", "주간 브리핑", "톱뉴스", "헤드라인 모음"
]
